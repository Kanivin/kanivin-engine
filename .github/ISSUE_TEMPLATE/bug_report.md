...
1. This tracker should only be used to report bugs and request features / enhancements to Kanivin
    ...
    - For documentation issues, refer to https://frappeframework.com/docs/user/en or the developer cheetsheet https://github.com/Kanivin/kanivin-engine/wiki/Developer-Cheatsheet
