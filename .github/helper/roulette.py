...
def get_files_list(pr_number, repo="kanivin/kanivin"):
...
def has_skip_ci_label(pr_number, repo="kanivin/kanivin"):
	return has_label(pr_number, "Skip CI", repo)


def has_run_server_tests_label(pr_number, repo="kanivin/kanivin"):
	return has_label(pr_number, "Run Server Tests", repo)


def has_run_ui_tests_label(pr_number, repo="kanivin/kanivin"):
	return has_label(pr_number, "Run UI Tests", repo)


def has_label(pr_number, label, repo="kanivin/kanivin"):
	return any(
		[
			fetched_label["name"]
