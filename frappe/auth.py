...
class HTTPRequest:
	...
	def validate_csrf_token(self):
		if (
			...
			or (
				(frappe.get_request_header("X-Kanivin-CSRF-Token") or frappe.form_dict.pop("csrf_token", None))
				== saved_token
			)
		):
			return
...
def validate_auth_via_api_keys(authorization_header):
	...
	try:
		...
		authorization_source = frappe.get_request_header("Kanivin-Authorization-Source")
