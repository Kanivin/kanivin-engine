...
context("Form Builder", () => {
	...
	it("Add Table field and check if columns are rendered", () => {
		...
		cy.get(".sidebar-container .kanivin-control[data-fieldname='options'] input")
			.click()
			.as("input");
	...
	it("Validate Duplicate Name & reqd + hidden without default logic", () => {
		...
		cy.get(".sidebar-container .kanivin-control[data-fieldname='fieldname'] input")
			.click()
			.as("input");
		cy.get(".sidebar-container .kanivin-control[data-fieldname='fieldname'] input")
			.clear({ force: true })
		...
		cy.hide_dialog();
		cy.get(last_field).click();
		cy.get(".sidebar-container .kanivin-control[data-fieldname='fieldname'] input").clear({
			force: true,
		});
