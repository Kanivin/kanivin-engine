context("Workspace 2.0", () => {
	...
	it("Create Private Page", () => {
		cy.intercept({
			method: "POST",
			url: "api/method/kanivin.desk.doctype.workspace.workspace.new_page",
		}).as("new_page");
	...
	it("Duplicate Page", () => {
		cy.intercept({
			method: "POST",
			url: "api/method/kanivin.desk.doctype.workspace.workspace.duplicate_page",
		}).as("page_duplicated");
	...
	it("Drag Sidebar Item", () => {
		cy.intercept({
			method: "POST",
			url: "api/method/kanivin.desk.doctype.workspace.workspace.sort_pages",
		}).as("page_sorted");
	...
	it("Edit Page Detail", () => {
		cy.intercept({
			method: "POST",
			url: "api/method/kanivin.desk.doctype.workspace.workspace.update_page",
		}).as("page_updated");
	...
	it("Hide/Unhide Workspaces", () => {
		...
		cy.intercept({
			method: "POST",
			url: "api/method/kanivin.desk.doctype.workspace.workspace.hide_page",
		}).as("hide_page");
		...
		cy.intercept({
			method: "POST",
			url: "api/method/kanivin.desk.doctype.workspace.workspace.unhide_page",
		}).as("unhide_page");
	...
	it("Delete Duplicate Page", () => {
		cy.intercept({
			method: "POST",
			url: "api/method/kanivin.desk.doctype.workspace.workspace.delete_page",
		}).as("page_deleted");
