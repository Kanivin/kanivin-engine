...
context("Sidebar", () => {
	before(() => {
		...
		return cy
			...
			.its("kanivin")
			.then((kanivin) => {
				return kanivin.call("kanivin.tests.ui_test_helpers.create_blog_post");
			});
	});

	it("Verify attachment visibility config", () => {
		cy.call("kanivin.tests.ui_test_helpers.create_todo", {
	...
	it("Verify attachment accessibility UX", () => {
		cy.call("kanivin.tests.ui_test_helpers.create_todo_with_attachment_limit", {
