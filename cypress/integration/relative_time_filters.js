...
// 		cy.window().its('kanivin').then(kanivin => {
// 			kanivin.call("kanivin.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/kanivin.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/kanivin.model.utils.user_settings.save')
