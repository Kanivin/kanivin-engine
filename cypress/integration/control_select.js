context("Control Select", () => {
	...
	it("toggles placholder on clicking an option", () => {
		...
		cy.get(".kanivin-control[data-fieldname=select_control] .control-input").as("control");
		cy.get(".kanivin-control[data-fieldname=select_control] .control-input select").as(
			"select"
		);
