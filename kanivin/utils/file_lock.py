...
Use `kanivin.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import kanivin
from kanivin.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in kanivin.local.locked_documents:
		doc.unlock()
