...
from kanivin.utils import get_bench_path, get_site_path
from kanivin.utils.file_lock import LockTimeoutError
...
def filelock(lock_name: str, *, timeout=30, is_global=False):
	...
	try:
		...
		kanivin.log_error("Filelock: Failed to aquire {lock_path}")
