...
def get_print(
	...
	from kanivin.website.serve import get_response_without_exception_handling
	...
	if "pdf_generator" not in local.form_dict:
		...
		if pdf_generator is None:
			pdf_generator = (
				kanivin.get_cached_value("Print Format", print_format, "pdf_generator") or "wkhtmltopdf"
			)
	...
	if local.form_dict.pdf_generator != "wkhtmltopdf":
		hook_func = kanivin.get_hooks("pdf_generator")
