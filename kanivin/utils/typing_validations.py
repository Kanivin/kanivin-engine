...
from kanivin.exceptions import KanivinTypeError
...
KanivinPydanticConfig = ConfigDict(arbitrary_types_allowed=True)
...
def TypeAdapter(type_):
	...
	return PyTypeAdapter(type_, config=KanivinPydanticConfig)
