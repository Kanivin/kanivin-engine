...
kanivin.query_reports["Database Storage Usage By Tables"] = {
	filters: [],
			...
			function () {
				let d = new kanivin.ui.Dialog({
					...
					primary_action(values) {
						kanivin.call({
							method: "kanivin.core.report.database_storage_usage_by_tables.database_storage_usage_by_tables.optimize_doctype",
							args: {
