kanivin.ui.form.on("Version", "refresh", function (frm) {
	$(
		kanivin.render_template("version_view", { doc: frm.doc, data: JSON.parse(frm.doc.data) })
	).appendTo(frm.fields_dict.table_html.$wrapper.empty());

	frm.add_custom_button(__("Show all Versions"), function () {
		kanivin.set_route("List", "Version", {
