...
class TestRoleProfile(KanivinTestCase):
	def test_make_new_role_profile(self):
		kanivin.delete_doc_if_exists("Role Profile", "Test 1", force=1)
		new_role_profile = kanivin.get_doc(dict(doctype="Role Profile", role_profile="Test 1")).insert()
