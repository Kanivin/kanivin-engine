...
from kanivin.utils import cint, convert_utc_to_system_timezone
from kanivin.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> kanivin._dict:
	...
	if current_job and not current_job.startswith(kanivin.local.site):
		current_job = None
