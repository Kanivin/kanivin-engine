...
from kanivin.translate import MERGED_TRANSLATION_KEY, USER_TRANSLATION_KEY
...
def clear_user_translation_cache(lang):
	kanivin.cache.hdel(USER_TRANSLATION_KEY, lang)
	kanivin.cache.hdel(MERGED_TRANSLATION_KEY, lang)
