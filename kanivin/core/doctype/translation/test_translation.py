...
class TestTranslation(KanivinTestCase):
	def setUp(self):
		kanivin.db.delete("Translation")

	def tearDown(self):
		kanivin.local.lang = "en"
		from kanivin.translate import clear_cache
	...
	def test_doctype(self):
		...
		for lang, (source_string, new_translation) in translation_data.items():
			...
			kanivin.delete_doc("Translation", docname)
