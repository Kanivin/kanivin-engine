...
from kanivin.database.postgres.schema import PostgresTable
from kanivin.database.utils import EmptyQueryValues, LazyDecode
from kanivin.utils import cstr, get_table_name
...
class PostgresExceptionUtil:
	...
	def is_statement_timeout(e):
		return PostgresDatabase.is_timedout(e) or isinstance(e, kanivin.QueryTimeoutError)
	...
	def get_tables(self, cached=True):
		return [
			...
			where table_catalog='{}'
				...
				and table_schema='{}'""".format(self.cur_db_name, kanivin.conf.get("db_schema", "public"))
			)
		]
