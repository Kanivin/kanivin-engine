...
class DbManager:
	...
	def restore_database(verbose: bool, target: str, source: str, user: str, password: str) -> None:
		...
		from kanivin.utils import execute_in_shell
		...
		kanivin.cache.delete_keys("")  # Delete all keys associated with this site.
