...
class EmailTemplate(Document):
	...
	def get_formatted_subject(self, doc):
		return kanivin.render_template(self.subject, doc)

	def get_formatted_response(self, doc):
		return kanivin.render_template(self.response_, doc)
...
def get_email_template(template_name, doc):
	...
	email_template = kanivin.get_doc("Email Template", template_name)
