...
from kanivin.utils import validate_url

# test_records = kanivin.get_test_records('Email Group')


class TestEmailGroup(KanivinTestCase):
	def test_welcome_url(self):
		email_group = kanivin.new_doc("Email Group")
