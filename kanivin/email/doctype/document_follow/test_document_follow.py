...
import kanivin
import kanivin.desk.form.document_follow as document_follow
from kanivin.desk.form.assign_to import add
from kanivin.desk.form.document_follow import get_document_followed_by_user
from kanivin.desk.form.utils import add_comment
from kanivin.desk.like import toggle_like
from kanivin.query_builder import DocType
from kanivin.query_builder.functions import Cast_
from kanivin.share import add as share
from kanivin.tests.utils import KanivinTestCase


class TestDocumentFollow(KanivinTestCase):
	...
	def tearDown(self):
		...
		kanivin.db.delete("Document Follow")
	...
	doc = kanivin.get_doc(
		{
			...
			"doc.starts_on": kanivin.utils.now(),
			"doc.ends_on": kanivin.utils.add_days(kanivin.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if kanivin.db.exists("User", "test@docsub.com"):
		doc = kanivin.delete_doc("User", "test@docsub.com")
	doc = kanivin.new_doc("User")
