...
import kanivin
from kanivin import safe_decode
from kanivin.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from kanivin.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from kanivin.email.receive import Email
from kanivin.tests.utils import KanivinTestCase


class TestEmailBody(KanivinTestCase):
	def setUp(self):
		email_html = """
<div>
	<h3>Hey John Doe!</h3>
	<p>This is embedded image you asked for</p>
	<img embed="assets/kanivin/images/kanivin-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/kanivin/images/kanivin-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = kanivin.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="kanivin-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/kanivin/images/kanivin-favicon.svg" alt="test" />
