...
window.validate_email = function (txt) {
	return kanivin.utils.validate_type(txt, "email");
};

window.validate_phone = function (txt) {
	return kanivin.utils.validate_type(txt, "phone");
};

window.validate_name = function (txt) {
	return kanivin.utils.validate_type(txt, "name");
};

window.validate_url = function (txt) {
	return kanivin.utils.validate_type(txt, "url");
};
