...
kanivin.ui.Scanner = class Scanner {
	constructor(options) {
		this.dialog = null;
		this.handler = null;
		...
		if (options.container) {
			...
			this.scan_area_id = kanivin.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return kanivin.require("/assets/kanivin/node_modules/html5-qrcode/html5-qrcode.min.js");
	}
};
