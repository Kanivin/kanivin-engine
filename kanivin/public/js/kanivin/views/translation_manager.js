kanivin.views.TranslationManager = class TranslationManager {
	constructor(opts) {
	...
	get_translations_data() {
		return kanivin.db.get_list("Translation", {
	...
	update_translations({ source, translation_data = [] }) {
		...
		return kanivin
			.call({
				method: "kanivin.translate.update_translations_for_source",
