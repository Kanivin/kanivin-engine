export default class GridPagination {
	...
	get_pagination_html() {
		...
		return $(`<button class="btn btn-secondary btn-xs first-page"">
			...
			<button class="btn btn-secondary btn-xs prev-page">${kanivin.utils.icon("left", "xs")}</button>
			${page_text_html}
			<button class="btn btn-secondary btn-xs next-page">${kanivin.utils.icon("right", "xs")}</button>
