kanivin.ui.form.ControlDuration = class ControlDuration extends kanivin.ui.form.ControlData {
	make_input() {
		super.make_input();
		this.make_picker();
	}
	...
	set_duration_options() {
		this.duration_options = kanivin.utils.get_duration_options(this.df);
	}

	set_duration_picker_value(value) {
		let total_duration = kanivin.utils.seconds_to_duration(value, this.duration_options);
	...
	bind_events() {
		...
		this.$picker.on("change", ".duration-input", () => {
			...
			let value = kanivin.utils.duration_to_seconds(
				duration.days,
				duration.hours,
				duration.minutes,
				duration.seconds
	...
	format_for_input(value) {
		return kanivin.utils.get_formatted_duration(value, this.duration_options);
	}
