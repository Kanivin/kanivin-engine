...
kanivin.ui.form.ControlComment = class ControlComment extends kanivin.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${kanivin.avatar(kanivin.session.user, "avatar-medium")}
					<div class="kanivin-control col"></div>
				</div>
		...
		`)
			: $('<div class="kanivin-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to kanivin-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".kanivin-control")
