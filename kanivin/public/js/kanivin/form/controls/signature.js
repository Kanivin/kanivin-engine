kanivin.ui.form.ControlSignature = class ControlSignature extends kanivin.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		kanivin.require("/assets/kanivin/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${kanivin.utils.icon("restriction", "md")}</i>
