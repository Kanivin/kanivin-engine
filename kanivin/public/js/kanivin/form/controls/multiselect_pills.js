...
kanivin.ui.form.ControlMultiSelectPills = class ControlMultiSelectPills extends (
	kanivin.ui.form.ControlAutocomplete
) {
	make_input() {
		super.make_input();
	...
	get_pill_html(value) {
		...
		return `
			<button class="data-pill btn tb-selected-value" data-value="${encoded_value}">
				<span class="btn-link-to-form">${__(label || kanivin.utils.escape_html(value))}</span>
