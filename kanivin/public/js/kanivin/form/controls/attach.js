kanivin.ui.form.ControlAttach = class ControlAttach extends kanivin.ui.form.ControlData {
	make_input() {
		let me = this;
		...
		this.$value = $(
			`<div class="attached-file flex justify-between align-center">
				<div class="ellipsis">
				${kanivin.utils.icon("es-line-link", "sm")}
		...
		kanivin.utils.bind_actions_with_object(this.$value, this);
	...
	on_attach_click() {
		...
		this.file_uploader = new kanivin.ui.FileUploader(this.upload_options);
	}
	on_attach_doc_image() {
		this.set_upload_options();
