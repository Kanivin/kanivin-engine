...
kanivin.provide("kanivin.widget");

kanivin.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
kanivin.widget.make_widget = (opts) => {
	const widget_class = kanivin.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = kanivin.widget.make_widget({
			...widget,
...
kanivin.widget.WidgetGroup = WidgetGroup;
kanivin.widget.SingleWidgetGroup = SingleWidgetGroup;
