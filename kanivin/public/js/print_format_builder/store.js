...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			kanivin.model.clear_doc("Print Format", print_format_name);
			kanivin.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = kanivin.get_doc("Print Format", print_format_name);
				kanivin.model.with_doctype(_print_format.doc_type, () => {
					meta.value = kanivin.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return kanivin.db.get_doc("Letter Head", _letterhead).then((doc) => {
