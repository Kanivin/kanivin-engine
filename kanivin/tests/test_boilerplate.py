...
import kanivin
from kanivin.modules.patch_handler import get_all_patches, parse_as_configfile
from kanivin.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = kanivin._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.default_user_input = kanivin._dict(
			{
				"title": "Test App",
		...
		cls.bench_path = kanivin.utils.get_bench_path()
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(kanivin.get_app_path("kanivin", "patches.txt")))
		...
		expected_patch = "kanivin.core.doctype.user.patches.delete_all_users"
