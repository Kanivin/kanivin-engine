...
from kanivin.utils import fmt_money


class TestFmtMoney(KanivinTestCase):
	def test_standard(self):
		kanivin.db.set_default("number_format", "#,###.##")
	...
	def test_currency_precision(self):
		kanivin.db.set_default("currency_precision", "4")
		kanivin.db.set_default("number_format", "#,###.##")
		self.assertEqual(fmt_money(100), "100.00")
		self.assertEqual(fmt_money(1000), "1,000.00")
		self.assertEqual(fmt_money(10000), "10,000.00")
		...
		kanivin.db.set_default("currency_precision", "")
	...
	def test_fmt_with_symbol_pos(self):
		kanivin.db.set_value("Currency", "JPY", "symbol_on_right", 1)
