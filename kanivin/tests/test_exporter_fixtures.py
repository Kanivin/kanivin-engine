...
class TestDataImportFixtures(KanivinTestCase):
	def setUp(self):
		pass
	...
	def test_Custom_Script_fixture_simple(self):
		...
		path = kanivin.scrub(fixture) + "_original_style.csv"
	...
	def test_Custom_Script_fixture_simple_name_equal_default(self):
		...
		path = kanivin.scrub(fixture[0]) + "_simple_name_equal_default.csv"
	...
	def test_Custom_Script_fixture_simple_name_equal(self):
		...
		path = kanivin.scrub(fixture[0]) + "_simple_name_equal.csv"
	...
	def test_Custom_Script_fixture_simple_name_not_equal(self):
		fixture = ["Client Script", {"name": ["Item"], "op": "!="}]
		path = kanivin.scrub(fixture[0]) + "_simple_name_not_equal.csv"
	...
	def test_Custom_Script_fixture_simple_name_at_least_equal(self):
		...
		path = kanivin.scrub(fixture[0]) + "_simple_name_at_least_equal.csv"
	...
	def test_Custom_Script_fixture_multi_name_equal(self):
		...
		path = kanivin.scrub(fixture[0]) + "_multi_name_equal.csv"
	...
	def test_Custom_Script_fixture_multi_name_not_equal(self):
		fixture = ["Client Script", {"name": ["Item", "Customer"], "op": "!="}]
		path = kanivin.scrub(fixture[0]) + "_multi_name_not_equal.csv"
	...
	def test_Custom_Script_fixture_empty_object(self):
		fixture = ["Client Script", {}]
		path = kanivin.scrub(fixture[0]) + "_empty_object_should_be_all.csv"
	...
	def test_Custom_Script_fixture_just_list(self):
		fixture = ["Client Script"]
		path = kanivin.scrub(fixture[0]) + "_just_list_should_be_all.csv"
	...
	def test_Custom_Script_fixture_rex_no_flags(self):
		...
		path = kanivin.scrub(fixture[0]) + "_rex_no_flags.csv"
	...
	def test_Custom_Script_fixture_rex_with_flags(self):
		...
		path = kanivin.scrub(fixture[0]) + "_rex_with_flags.csv"
	...
	def test_Doctype_fixture_simple(self):
		fixture = "ToDo"
		path = "Doctype_" + kanivin.scrub(fixture) + "_original_style_should_be_all.csv"
	...
	def test_Doctype_fixture_simple_name_equal_default(self):
		...
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_simple_name_equal_default.csv"
	...
	def test_Doctype_fixture_simple_name_equal(self):
		...
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_simple_name_equal.csv"
	...
	def test_Doctype_simple_name_not_equal(self):
		fixture = ["ToDo", {"name": ["TDI00000002"], "op": "!="}]
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_simple_name_not_equal.csv"
	...
	def test_Doctype_fixture_simple_name_at_least_equal(self):
		...
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_simple_name_at_least_equal.csv"
	...
	def test_Doctype_multi_name_equal(self):
		...
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_multi_name_equal.csv"
	...
	def test_Doctype_multi_name_not_equal(self):
		fixture = ["ToDo", {"name": ["TDI00000002", "TDI00000008"], "op": "!="}]
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_multi_name_not_equal.csv"
	...
	def test_Doctype_fixture_empty_object(self):
		fixture = ["ToDo", {}]
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_empty_object_should_be_all.csv"
	...
	def test_Doctype_fixture_just_list(self):
		fixture = ["ToDo"]
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_just_list_should_be_all.csv"
	...
	def test_Doctype_fixture_rex_no_flags(self):
		...
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_rex_no_flags_should_be_all.csv"
	...
	def test_Doctype_fixture_rex_with_flags(self):
		...
		path = "Doctype_" + kanivin.scrub(fixture[0]) + "_rex_with_flags_should_be_none.csv"
