...
from kanivin.utils import format_date, today
from kanivin.utils.goal import get_monthly_goal_graph_data, get_monthly_results


class TestGoal(KanivinTestCase):
	def setUp(self):
	...
	def test_get_monthly_goal_graph_data(self):
		...
		docname = kanivin.get_list("Event", filters={"subject": ["=", "_Test Event 1"]})[0]["name"]
		kanivin.db.set_value("Event", docname, "description", 1)
