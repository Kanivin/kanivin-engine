...
class DocTypeLayout(Document):
	...
	if TYPE_CHECKING:
		from kanivin.custom.doctype.doctype_layout_field.doctype_layout_field import DocTypeLayoutField
	...
	def sync_fields(self):
		doctype_fields = kanivin.get_meta(self.document_type, cached=False).fields
