...
import 
from .core.utils import html2text
...
def get_remote_script(remote_site):
	...
	if request.status_code / 100 != 2:
		...
		click.secho(
			"Some errors occurred while recovering the migration script. Please contact us @ Kanivin Cloud if this issue persists",
			fg="yellow",
		)
		return
