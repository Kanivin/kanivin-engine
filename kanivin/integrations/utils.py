...
import kanivin
from kanivin.utils import get_request_session
...
def make_request(method, url, auth=None, headers=None, data=None, json=None, params=None):
	...
	try:
		...
		response = kanivin.flags.integration_request = s.request(
...
def create_request_log(
	...
	**kwargs,
	...
	integration_request = kanivin.get_doc(
		{
...
def get_json(obj):
	return obj if isinstance(obj, str) else kanivin.as_json(obj, indent=1)
