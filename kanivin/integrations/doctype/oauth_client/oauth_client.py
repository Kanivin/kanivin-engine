...
from kanivin.permissions import SYSTEM_USER_ROLE
...
class OAuthClient(Document):
	...
	if TYPE_CHECKING:
		from kanivin.integrations.doctype.oauth_client_role.oauth_client_role import OAuthClientRole
	...
	def validate(self):
		...
		if not self.client_secret:
			self.client_secret = kanivin.generate_hash(length=10)
	...
	def user_has_allowed_role(self) -> bool:
		...
		return bool(allowed_roles & set(kanivin.get_roles()))
