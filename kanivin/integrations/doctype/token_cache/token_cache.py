...
from kanivin.utils import cint, cstr, get_system_timezone
...
class TokenCache(Document):
	...
	if TYPE_CHECKING:
		from kanivin.integrations.doctype.oauth_scope.oauth_scope import OAuthScope
	...
	def get_auth_header(self):
		...
		raise kanivin.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			kanivin.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
	...
	def get_expires_in(self):
		...
		modified = kanivin.utils.get_datetime(self.modified)
