...
class TestTokenCache(KanivinTestCase):
	def setUp(self):
		self.token_cache = kanivin.get_last_doc("Token Cache")
		self.token_cache.update({"connected_app": kanivin.get_last_doc("Connected App").name})
