...
class TestGoogleSettings(KanivinTestCase):
	def setUp(self):
		settings = .get_single("Google Settings")
	...
	def test_picker_disabled(self):
		...
		.db.set_single_value("Google Settings", "enable", 1)
		.db.set_single_value("Google Settings", "google_drive_picker_enabled", 0)
	...
	def test_google_disabled(self):
		...
		.db.set_single_value("Google Settings", "enable", 0)
		.db.set_single_value("Google Settings", "google_drive_picker_enabled", 1)
		settings = get_file_picker_settings()
