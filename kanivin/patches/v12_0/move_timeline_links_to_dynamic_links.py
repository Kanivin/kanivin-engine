...
def execute():
		...
		if communication.timeline_doctype and communication.timeline_name:
			...
			values.append(
				"""({}, "{}", "timeline_links", "Communication", "{}", "{}", "{}", "{}", "{}", "{}")""".format(
					counter,
					str(name),
					kanivin.db.escape(communication.name),
					kanivin.db.escape(communication.timeline_doctype),
					kanivin.db.escape(communication.timeline_name),
		...
		if communication.link_doctype and communication.link_name:
			...
			values.append(
				"""({}, "{}", "timeline_links", "Communication", "{}", "{}", "{}", "{}", "{}", "{}")""".format(
					...
					str(name),
					kanivin.db.escape(communication.name),
					kanivin.db.escape(communication.link_doctype),
					kanivin.db.escape(communication.link_name),
					communication.creation,
					communication.modified,
					communication.modified_by,
				)
	...
	kanivin.db.add_index("Communication Link", ["link_doctype", "link_name"])
