...
def execute():
	...
	reports = kanivin.get_all("Report", {"report_type": "Report Builder"})

	for report_name in reports:
		settings = kanivin.db.get_value("Report", report_name, "json")
		if not settings:
			continue

		settings = kanivin._dict(json.loads(settings))
		...
		kanivin.db.set_value("Report", report_name, "json", json.dumps(settings))
