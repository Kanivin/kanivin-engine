...
def execute():
	kanivin.reload_doc("core", "doctype", "docfield", force=True)
	kanivin.reload_doc("custom", "doctype", "custom_field", force=True)
	kanivin.reload_doc("custom", "doctype", "customize_form_field", force=True)
	kanivin.reload_doc("custom", "doctype", "property_setter", force=True)
