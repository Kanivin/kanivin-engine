import kanivin
from kanivin.core.doctype.log_settings.log_settings import clear_log_table
from kanivin.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/kanivin/kanivin/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(kanivin.db.exists(doctype, {"modified": ("<", threshold)}))


def get_current_setting(fieldname):
	try:
		return kanivin.db.get_single_value("Log Settings", fieldname)
	except Exception:
