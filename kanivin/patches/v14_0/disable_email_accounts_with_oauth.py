import kanivin
from kanivin.desk.doctype.notification_log.notification_log import make_notification_logs


def execute():
	if kanivin.get_all("Email Account", {"auth_method": "OAuth", "connected_user": ["is", "set"]}, limit=1):
		return
	...
	kanivin.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = kanivin.qb.DocType("User").as_("user")
	user_role_doctype = kanivin.qb.DocType("Has Role").as_("user_role")
	return (
