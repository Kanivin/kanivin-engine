...
from kanivin.desk.form.load import run_onload
...
from kanivin.utils.telemetry import capture_doc


@kanivin.whitelist()
def savedocs(doc, action):
	"""save / submit / update doclist"""
	doc = kanivin.get_doc(json.loads(doc))
	...
	kanivin.msgprint(kanivin._("Saved"), indicator="green", alert=True)
...
def cancel(doctype=None, name=None, workflow_state_fieldname=None, workflow_state=None):
	...
	doc.cancel()
	send_updated_docs(doc)
	kanivin.msgprint(kanivin._("Cancelled"), indicator="red", alert=True)
...
def send_updated_docs(doc):
	...
	kanivin.response.docs.append(d)
