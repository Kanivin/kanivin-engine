# Copyright (c) 2015, Kanivin Pvt. Ltd. and Contributors and Contributors
# License: MIT. See LICENSE

import kanivin
from kanivin.tests.utils import KanivinTestCase

test_records = kanivin.get_test_records("Note")


class TestNote(KanivinTestCase):
	def insert_note(self):
		kanivin.db.delete("Version")
		kanivin.db.delete("Note")
		kanivin.db.delete("Note Seen By")

		return kanivin.get_doc(dict(doctype="Note", title="test note", content="test note content")).insert()
	...
	def test_version(self):
		...
		version = kanivin.get_doc("Version", dict(docname=note.name))
