...
kanivin.ui.form.on("Workspace", {
	setup: function () {
		kanivin.meta.get_field("Workspace Link", "only_for").no_default = true;
	},
	...
	refresh: function (frm) {
		...
		let url = `/app/${
			frm.doc.public
				? kanivin.router.slug(frm.doc.title)
				: "private/" + kanivin.router.slug(frm.doc.title)
		}`;
		frm.sidebar
		...
		if (
			...
			(frm.doc.public &&
				!frm.has_perm("write") &&
				!kanivin.user.has_role("Workspace Manager"))
		) {
