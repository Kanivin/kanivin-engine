...
class TestWorkspace(KanivinTestCase):
	def setUp(self):
		create_module("Test Module")

	def tearDown(self):
		kanivin.db.delete("Workspace", {"module": "Test Module"})
		kanivin.db.delete("DocType", {"module": "Test Module"})
		kanivin.delete_doc("Module Def", "Test Module")
	...
	# 	if kanivin.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = kanivin.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "kanivin"})
...
def create_workspace(**args):
	workspace = kanivin.new_doc("Workspace")
