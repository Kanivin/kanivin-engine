...
from kanivin.social.doctype.energy_point_log.energy_point_log import create_review_points_log
from kanivin.utils import add_to_date, getdate, today
...
class EnergyPointSettings(Document):
	...
	if TYPE_CHECKING:
		from kanivin.social.doctype.review_level.review_level import ReviewLevel
...
def is_energy_point_enabled():
	return kanivin.db.get_single_value("Energy Point Settings", "enabled", True)
