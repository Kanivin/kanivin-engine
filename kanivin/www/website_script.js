...
{% if enable_view_tracking %}
	if (navigator.doNotTrack != 1 && !window.is_404) {
		kanivin.ready(() => {
			let browser = kanivin.utils.get_browser();
			let query_params = kanivin.utils.get_query_params();
			...
			import('https://openfpcdn.io/fingerprintjs/v3')
				...
				.then(fp => fp.get())
				.then(result => {
					kanivin.call("kanivin.website.doctype.web_page_view.web_page_view.make_view_log", {
