...
from kanivin.utils import get_url, nowdate
from kanivin.utils.caching import redis_cache
from kanivin.website.router import get_doctypes_with_web_view, get_pages
...
def get_public_pages_from_doctypes():
	...
	if robots_txt := kanivin.db.get_single_value("Website Settings", "robots_txt"):
