...
import kanivin
from kanivin.utils import cstr, escape_html, get_request_site_address, now
...
def get_context(context):
	...
	blog_settings = kanivin.get_doc("Blog Settings", "Blog Settings")
