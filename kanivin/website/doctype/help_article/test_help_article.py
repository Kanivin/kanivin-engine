...
# test_records = kanivin.get_test_records('Help Article')


class TestHelpArticle(KanivinTestCase):
	@classmethod
	def setUpClass(cls) -> None:
		cls.help_category = kanivin.get_doc(
			{
		...
		cls.help_article = kanivin.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from kanivin.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		kanivin.delete_doc(cls.help_article.doctype, cls.help_article.name)
		kanivin.delete_doc(cls.help_category.doctype, cls.help_category.name)
