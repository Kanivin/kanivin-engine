const { kanivin_request } = require("../utils");
const log = console.log;

const WEBSITE_ROOM = "website";
const SITE_ROOM = "all";

function kanivin_handlers(realtime, socket) {
...
function can_subscribe_doctype(args) {
	...
	kanivin_request("/api/method/kanivin.realtime.can_subscribe_doctype", args.socket)
		.type("form")
		.query({
...
function can_subscribe_doc(args) {
	...
	kanivin_request("/api/method/kanivin.realtime.can_subscribe_doc", args.socket)
		.type("form")
		.query({
			doctype: args.doctype,
			docname: args.docname,
...
module.exports = kanivin_handlers;
